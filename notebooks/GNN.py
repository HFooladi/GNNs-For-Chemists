...
# + colab={"base_uri": "https://localhost:8080/"} executionInfo={"elapsed": 427, "status": "ok", "timestamp": 1718120215721, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="g7qWzN_WAQXi" outputId="e2030510-80d4-424f-a93e-6efa78c65609"
# !wget https://github.com/whitead/dmol-book/blob/main/dl/methanol.jpg?raw=true -O ../content/methanol.jpg

# + colab={"base_uri": "https://localhost:8080/", "height": 1000} executionInfo={"elapsed": 877, "status": "ok", "timestamp": 1718120216597, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="rtY4-jnJ-753" outputId="c6cf4baf-ccc7-4885-e281-018304e17b19"
...
# + colab={"base_uri": "https://localhost:8080/"} executionInfo={"elapsed": 11309, "status": "ok", "timestamp": 1718120227901, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="1_Cz048WcTFZ" outputId="e0d9bdcf-ac8f-4e1a-eceb-d8e80f10b810"
# !pip install rdkit myst_nb

# + executionInfo={"elapsed": 7493, "status": "ok", "timestamp": 1718120235390, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="ZSvUhfnF6gUJ"
...
# + executionInfo={"elapsed": 403, "status": "ok", "timestamp": 1718120235788, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="-cS6Bmqm6gUK"
soldata = pd.read_csv(
...
# + executionInfo={"elapsed": 6, "status": "ok", "timestamp": 1718120235788, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="8HZtV6iw6gUL" tags=["hide-cell"]
...
# + colab={"base_uri": "https://localhost:8080/"} executionInfo={"elapsed": 5, "status": "ok", "timestamp": 1718120235788, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="tFpysogc6gUL" outputId="443de0ee-610f-4e05-9249-353a035049b5"
nodes, adj = smiles2graph("CO")
nodes
## number of rows are the number of atoms in the moelcule, and the number of columns are the features for each node

# + colab={"base_uri": "https://localhost:8080/"} executionInfo={"elapsed": 3, "status": "ok", "timestamp": 1718120235788, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="4CAqsZcEfS20" outputId="f13510e8-9149-4ef9-8bb9-7a951af6ed81"
...
# + colab={"base_uri": "https://localhost:8080/", "height": 422} executionInfo={"elapsed": 1441, "status": "ok", "timestamp": 1718120237226, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="zOLXrm0wdifJ" outputId="36c9cfca-ff96-46d6-cc02-373e94e2f5bb"
...
# + colab={"base_uri": "https://localhost:8080/", "height": 1000} executionInfo={"elapsed": 36129, "status": "ok", "timestamp": 1718120273354, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="-fvAwidx6gUM" outputId="0eabdc74-5760-479d-ad43-0d165f89cf73" tags=["remove-cell"]
# THIS CELL IS USED TO GENERATE A FIGURE
# AND NOT RELATED TO CHAPTER
# YOU CAN SKIP IT
...
# + executionInfo={"elapsed": 8, "status": "ok", "timestamp": 1718120273354, "user": {"displayName": "Hosein Fooladi", "userId": "05481041717235244396"}, "user_tz": -120} id="_vlmpkZnjD-a"
